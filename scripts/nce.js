...
$('div').on('click', '.js-navigator', function(){
  console.log('listener fired');
  let clickedElement = event.currentTarget;
  let elementHandle = $(clickedElement).closest('div');
  let elementToChange = $(elementHandle).parent();
...
function initialText ( ) {
  ...
  <p><span class="businessname">Dr. Newman</span> received her undergraduate degree in English from Louisiana State University in Baton Rouge, La.; her Master of Arts degree in Speech Communication from Louisiana State University in Baton Rouge, La.; and her Doctorate of Communications from the University of Florida in Gainesville, Florida. She has held faculty appointments at Miami University of Ohio, College of Notre Dame, University of Maryland, and Bishop Dennis J. O'Connell High School.</p>
...
<p><span class ="js-navigator" "css-loadmore">Read More</span></p>
</div>
...
function medialText ( ) {
  console.log('medial text running');
  return `
